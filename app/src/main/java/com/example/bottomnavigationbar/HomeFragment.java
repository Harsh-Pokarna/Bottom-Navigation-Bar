...
public class HomeFragment extends Fragment {
    ...
    int[] images = {R.drawable.money_heist, R.drawable.money_heist, R.drawable.money_heist, R.drawable.money_heist
            , R.drawable.money_heist, R.drawable.money_heist, R.drawable.money_heist, R.drawable.money_heist
